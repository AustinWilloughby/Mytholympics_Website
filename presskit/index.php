...
if( file_exists('images/logo.png') ) {
	echo '<div class="uk-width-medium-1-2"><a href="images/logo.png"><img src="images/logo.png" alt="logo" /></a></div><br>';
}

if( file_exists('images/icon.png') ) {
	echo '<div class="uk-width-medium-1-2" style="height:300px;"><a href="images/icon.png"><img src="images/icon.png" alt="logo" /></a></div>';
}
...
echo '					<div class="uk-grid">
						<div class="uk-width-medium-1-2">
							<h2 id="credits">'. tl('Team & Collaborators') .'</h2>';
...
for( $i = 0; $i < count($credits); $i++ )
{
	...
	{
		echo '<strong>'.$person.'</strong><br/><a href="http://'.parseLink($website).'/" target="_blank">'.$role.'</a>';
	}
...
echo '						</div>
					...
					<p><a href="http://dopresskit.com/">presskit()</a> by Rami Ismail (<a href="http://www.vlambeer.com/">Vlambeer</a>) - also thanks to <a href="https://www.mytholympics.com/presskit/credits.html">these fine folks</a></p>
				</div>
			</div>
		</div>
